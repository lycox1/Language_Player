...
public class PlayList_Adapter extends BaseAdapter {
    ...
    ArrayList<PlayList_Item> playListFiles = new ArrayList<PlayList_Item>();

    public PlayList_Adapter() {}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PlayList_Item listViewItem = playListFiles.get(position);
    ...
    public void addItem(String filePath) {
        PlayList_Item item = new PlayList_Item(filePath);
