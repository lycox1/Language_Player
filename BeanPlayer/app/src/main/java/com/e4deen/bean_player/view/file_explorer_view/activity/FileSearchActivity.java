...
public class FileSearchActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Constants.sFileListManagerContext = this;
        mContext = this;
        ...
        fragmentTransaction.add(R.id.layout_playlist_manager, new Frag_plm_playlist(), Constants.FRAG_PLM_PLAYLIST);
    ...
    public void fragment_switch(int fragNum) {
        ...
        if(fragNum == Constants.IDX_PLM_FILELIST) {
            fragmentTransaction.replace(R.id.layout_playlist_manager, new Frag_plm_filelist(), Constants.FRAG_PLM_FILELIST);
            fragmentTransaction.addToBackStack(null);
            Constants.frag_plm_state = Constants.IDX_PLM_FILELIST;
        } else if(fragNum == Constants.IDX_PLM_PLAYLIST) {
            fragmentTransaction.replace(R.id.layout_playlist_manager, new Frag_plm_playlist(), Constants.FRAG_PLM_PLAYLIST);
            Constants.frag_plm_state = Constants.IDX_PLM_PLAYLIST;
            fragmentTransaction.addToBackStack(null);
        } else if(fragNum == Constants.IDX_PLM_PLAYLIST_FILES) {
            fragmentTransaction.replace(R.id.layout_playlist_manager, new Frag_plm_playlist_files(), Constants.FRAG_PLM_PLAYLIST_FILES);
